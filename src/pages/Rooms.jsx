...
export const Rooms = () => {
    ...
    return (
        <div className={` ${show ? 'overflow-hidden' : ''} min-h-[85vh] border-t border-t-[#504f4f]`}>
            {/* create room popup */}
            {
                show ? <div className='w-[100vw] h-[100vh] bg-[#000000a5] absolute top-0 left-0 flex items-center justify-center z-50 overflow-hidden'>
                    <div className='md:h-[550px] w-[90vw] lg:w-[500px] bg-[#1D1D1D] rounded-3xl'>
                        <div className='p-6'>
