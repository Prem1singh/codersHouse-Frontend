    ...
    return (
        <div>
            ...
            {email == false ? <Card register='true' title="Enter you phone number" logo="/phone.png">
                ...
                <div className='mt-6 relative mx-auto w-[230px]  mb-[15px]' ><img className='absolute left-[15px] w-[30px] top-[5px]' src="./flag.png" alt="" />
                ...
                <p className='mt-[15px] text-[#C4C5C5] md:text-[12px] text-[9px]'>By entering your number, you’re agreeing to our Terms of Service and Privacy Policy. Thanks!</p>
            </Card> :
